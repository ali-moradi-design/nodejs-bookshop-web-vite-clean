...
import { DISCOUNT_TYPES, type Discount } from '@/domain';
import { useDiscountsQuery } from '@/presentation/hooks/admin/use-discounts-query';
...
import { useSaveDiscountMutation } from '@/presentation/hooks/admin/use-save-discount-mutation';
import { useDeleteDiscountMutation } from '@/presentation/hooks/admin/use-delete-discount-mutation';
