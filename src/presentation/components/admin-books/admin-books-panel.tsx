...
import { useBooksQuery } from '@/presentation/hooks/catalog/use-books-query';
...
import { useSaveBookMutation } from '@/presentation/hooks/admin/use-save-book-mutation';
import { useDeleteBookMutation } from '@/presentation/hooks/admin/use-delete-book-mutation';
...
export function AdminBooksPanel() {
  ...
  const { uploadBookCover } = useDependencies();
