...
import { getRoleNames, type User } from '@/domain';
import { useUsersQuery } from '@/presentation/hooks/admin/use-users-query';
import { DataTable } from '@/shared/ui';
import { ApiError } from '@/shared/api';
import { Alert, Badge, Button, PageLoader } from '@/shared/ui';
import { useToggleUserActiveMutation } from '@/presentation/hooks/admin/use-toggle-user-active-mutation';
import { useDeleteUserMutation } from '@/presentation/hooks/admin/use-delete-user-mutation';
