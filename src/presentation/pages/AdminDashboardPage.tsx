...
import { useDashboardSummaryQuery } from '@/presentation/hooks/admin/use-dashboard-summary-query';
import { useLowStockQuery } from '@/presentation/hooks/admin/use-low-stock-query';
import { useRecentOrdersQuery } from '@/presentation/hooks/admin/use-recent-orders-query';
